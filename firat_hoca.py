...
class NerProcessor(DataProcessor):
    ...
    def get_labels(self):
        ...
        return ["O", "PERSON", "ORGANIZATION", "LOCATION", "X","[CLS]","[SEP]"]
...
def create_model(bert_config, is_training, input_ids, input_mask,
    ...
    with tf.variable_scope("loss"):
        ...
        logits = tf.reshape(logits, [-1, FLAGS.max_seq_length, 8]) #32
    ...
    def model_fn(features, labels, mode, params):
        ...
        if mode == tf.estimator.ModeKeys.TRAIN:
            ...
            # def metric_fn(label_ids, logits):
                ...
                predictions = tf.argmax(logits, axis=-1, output_type=tf.int32)
                precision = tf_metrics.precision(label_ids,predictions,13,[2,3,4],average="macro")
                recall = tf_metrics.recall(label_ids,predictions,13,[2,3,4],average="macro")
                f = tf_metrics.f1(label_ids,predictions,13,[2,3,4],average="macro")
                #
                return {
