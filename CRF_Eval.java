...
public class CRF_Eval {
    ...
    public static void coNllF1Score(String inputPath) {
        ...
        //if data has 3 labels annotationArray should be updated
        String[] annotationArray = {"PERSON", "ORGANIZATION", "LOCATION", "O","DATE","TIME","MONEY","PERCENT"};
        ...
        for (int i=0; i<8; i++) {
            try {
                ...
                System.out.print(String.format("%14s", annotation + "\t"));
                while (line != null) {
                    if (!line.isEmpty()) {
    ...
    public static void getMinimumPenalty(List<String> x, List<String> y, int pxy, int pgap) {
        ...
        System.out.println("Precision: " + precision + "\tRecall: " + recall + "\tSupport: " + x.size());
        return;
    }

    public static void main(String[] args) {
         coNllF1Score("output/result_dir/label_test.txt");
    }
}